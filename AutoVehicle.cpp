...
void Car::makeDecision(Json::Value jsonL, Json::Value jsonR)
{
    ...
    if(compareNumPeople(left, right) == 0)
    {
        cout << " stay in lane" << endl;
    } else if (compareNumPeople(left, right) == 1)
    {
        cout << " turn left" << endl;
    } else if (compareNumPeople(left, right) == 2) {
        cout << " turn right" << endl;
    } else if (compareNumPeople(left, right) == 0)
    {
        ...
        if(compareScores(left, right) == 1)
        {
            cout << " turn left" << endl;
        } else if (compareScores(left, right) == 2)
        {
            cout << " turn right" << endl;
        } else if (compareScores(left, right) == 0)
        {
            cout << " turn right" << endl;
...
int Car::compareNumPeople(Json::Value jsonL, Json::Value jsonR){
    int leftNumPeople = jsonL["passengers"];
    int rightNumPeople = jsonR["passengers"];
...
int Car::compareScores(Json::Value jsonL, Json::Value jsonR) {
    int leftRating = jsonL["rating"];
    int rightRating = jsonR["rating"];
